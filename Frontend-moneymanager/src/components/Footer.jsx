...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 text-gray-700 py-8 px-[12vw] md:px-[7vw] lg:px-[20vw] border-t border-gray-200">
      <div className="container mx-auto text-center">
        {/* Name / Logo */}
        <h2 className="text-lg font-semibold text-gray-800">Harikrishnan M R</h2>
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            <a
              ...
              className="text-xl text-gray-600 hover:text-gray-900 transition-transform transform hover:scale-110"
            >
              {item.icon}
            </a>
          ))}
        ...
        <p className="text-sm text-gray-500 mt-6">
          © 2025 Harikrishnan M R. All rights reserved.
        </p>
      </div>
    </footer>
  );
